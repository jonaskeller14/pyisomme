...
def calculate_tibia_index(channel_MOX: Channel,
    ...
    return Channel(
        code=channel_MOX.code.set(main_location="TIIN",
...
@debug_logging(logger)
def calculate_tibia_index_using_total_moment(channel_MOX: Channel,
                                             channel_MOY_total: Channel,
                                             channel_FOZ: Channel) -> Channel:
    tibia_index = calculate_tibia_index(channel_MOX=channel_MOX,
                                        channel_MOY=channel_MOY_total,
                                        channel_FOZ=channel_FOZ)
