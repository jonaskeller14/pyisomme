...
def calculate_neck_Mx_base(
    channel_Mx: Channel, channel_Fy: Channel, dz: float | None = None
...
@debug_logging(logger)
def calculate_neck_My_base(
    channel_My: Channel, channel_Fx: Channel, dz: float | None = None
) -> tuple[Channel, Channel]:
    """
    References:
    - references/Euro-NCAP/tb-021-data-acquisition-and-injury-calculation-v402.pdf
