...
| --- | --- | --- | --- |
| `Overall` | Weighting principles for overall rating / Table 3 | — | sum |

Manual inputs:

| input | type | default | unit | source | doc |
| --- | --- | --- | --- | --- | --- |
| p_driver | str | '1' | — | test report | Channel-code position of the driver. Defaults to the 'Driver position object 1' test-info field when available. |

## `criterion_driver` — Driver

| class | source | max rating | aggregation |
| --- | --- | --- | --- |
| `Criterion_Driver` | Weighting principles for overall rating / Table 3 (inherited) | — | sum |

## `criterion_driver/criterion_head_neck` — Head and neck

| class | source | max rating | aggregation |
| --- | --- | --- | --- |
| `Criterion_Head_Neck` | Weighting principles for overall rating / Table 3 (inherited) | — | min |
...
| class | source | max rating | aggregation |
| --- | --- | --- | --- |
| `Criterion_HIC_15` | Weighting principles for overall rating / Table 3 (inherited) | 0 (from limits) | — |
...
| class | source | max rating | aggregation |
| --- | --- | --- | --- |
| `Criterion_Nij` | Weighting principles for overall rating / Table 3 (inherited) | 0 (from limits) | — |
...
| class | source | max rating | aggregation |
| --- | --- | --- | --- |
| `Criterion_Neck_Tension` | Weighting principles for overall rating / Table 3 (inherited) | 0 (from limits) | — |
...
| class | source | max rating | aggregation |
| --- | --- | --- | --- |
| `Criterion_Neck_Compression` | Weighting principles for overall rating / Table 3 (inherited) | 0 (from limits) | — |
...
| class | source | max rating | aggregation |
| --- | --- | --- | --- |
| `Criterion_Neck_Tension_Corridor` | Weighting principles for overall rating / Table 3 (inherited) | 0 (from limits) | — |
...
| class | source | max rating | aggregation |
| --- | --- | --- | --- |
| `Criterion_Neck_Compression_Corridor` | Weighting principles for overall rating / Table 3 (inherited) | 0 (from limits) | — |
...
| class | source | max rating | aggregation |
| --- | --- | --- | --- |
| `Criterion_Neck_Shear_Corridor` | Weighting principles for overall rating / Table 3 (inherited) | 0 (from limits) | — |
...
| class | source | max rating | aggregation |
| --- | --- | --- | --- |
| `Criterion_Chest` | Weighting principles for overall rating / Table 3 (inherited) | — | min |

## `criterion_driver/criterion_chest/criterion_acceleration` — Thoracic spine acceleration (3 ms)

| class | source | max rating | aggregation |
| --- | --- | --- | --- |
| `Criterion_Thoracic_Spine_Acceleration` | Weighting principles for overall rating / Table 3 (inherited) | 0 (from limits) | — |
...
| class | source | max rating | aggregation |
| --- | --- | --- | --- |
| `Criterion_Sternum_Deflection` | Weighting principles for overall rating / Table 3 (inherited) | 0 (from limits) | — |
...
| class | source | max rating | aggregation |
| --- | --- | --- | --- |
| `Criterion_Sternum_Deflection_Rate` | Weighting principles for overall rating / Table 3 (inherited) | 0 (from limits) | — |
...
| class | source | max rating | aggregation |
| --- | --- | --- | --- |
| `Criterion_Chest_VC` | Weighting principles for overall rating / Table 3 (inherited) | 0 (from limits) | — |
...
| class | source | max rating | aggregation |
| --- | --- | --- | --- |
| `Criterion_Thigh_Hip` | Weighting principles for overall rating / Table 3 (inherited) | — | min |

## `criterion_driver/criterion_thigh_hip/criterion_left` — Left knee-thigh-hip injury risk

| class | source | max rating | aggregation |
| --- | --- | --- | --- |
| `Criterion_KTH_Left` | Weighting principles for overall rating / Table 3 (inherited) | — | — |

## `criterion_driver/criterion_thigh_hip/criterion_right` — Right knee-thigh-hip injury risk

| class | source | max rating | aggregation |
| --- | --- | --- | --- |
| `Criterion_KTH_Right` | Weighting principles for overall rating / Table 3 (inherited) | — | — |

## `criterion_driver/criterion_leg_foot` — Leg and foot

| class | source | max rating | aggregation |
| --- | --- | --- | --- |
| `Criterion_Leg_Foot` | Weighting principles for overall rating / Table 3 (inherited) | — | min |

## `criterion_driver/criterion_leg_foot/criterion_tibia_femur_displacement` — Tibia-femur displacement

| class | source | max rating | aggregation |
| --- | --- | --- | --- |
| `Criterion_Tibia_Femur_Displacement` | Weighting principles for overall rating / Table 3 (inherited) | 0 (from limits) | — |
...
| Marginal | -15 | -2 | orange | upper | mm | - |
| Poor | -18 | -4 | red | upper | mm | - |

## `criterion_driver/criterion_leg_foot/criterion_tibia_index` — Tibia index

| class | source | max rating | aggregation |
| --- | --- | --- | --- |
| `Criterion_Tibia_Index` | Weighting principles for overall rating / Table 3 (inherited) | 0 (from limits) | — |
...
| class | source | max rating | aggregation |
| --- | --- | --- | --- |
| `Criterion_Tibia_Axial_Force` | Weighting principles for overall rating / Table 3 (inherited) | 0 (from limits) | — |
...
| class | source | max rating | aggregation |
| --- | --- | --- | --- |
| `Criterion_Foot_Acceleration` | Weighting principles for overall rating / Table 3 (inherited) | 0 (from limits) | — |
...
| Marginal | 260 | -2 | orange | upper | g0 | - |
| Poor | 260 | -4 | red | lower | g0 | - |

## `criterion_restraints_kinematics` — Restraints and dummy kinematics

| class | source | max rating | aggregation |
| --- | --- | --- | --- |
| `Criterion_Restraints_Kinematics` | Weighting principles for overall rating / Table 3 (inherited) | — | — |

Manual inputs:

| input | type | default | unit | source | doc |
| --- | --- | --- | --- | --- | --- |
| automatic_poor | bool | False | — | video and postcrash inspection | True for late/nondeployment, seat-attachment failure, or vehicle-door opening. |
| demerits | int | 0 | — | video and postcrash inspection | Sum the Version VII Table 1 demerits. Frontal-airbag interaction is 0/1/2; lateral protection, steering-wheel motion, excursion and containment events are added as listed. |

## `criterion_structure` — Vehicle structure

| class | source | max rating | aggregation |
| --- | --- | --- | --- |
| `Criterion_Structure` | Weighting principles for overall rating / Table 3 (inherited) | — | — |
...
| intrusion_rating | int | 4 | — | intrusion measurements | Initial Figure 15 structure category: 4=Good, 3=Acceptable, 2=Marginal, 1=Poor. |
