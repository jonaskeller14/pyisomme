...
def build_hf_channels(
    ...
    channels = [
        ...
        create_sample(code="11NECKUP00HFMOYB", mode="sin", y_range=(-15,20), unit="Nm", noise_per=0.01),
        create_sample(code="11NECKUP00HFFOXA", mode="sin", y_range=(-300,400), unit="N", noise_per=0.01),
        create_sample(code="11NECKUP00HFFOZA", mode="pulse", y_range=(0,1200), unit="N", noise_per=0.01),
...
def build_h3_channels(
    ...
    channels = [
        ...
        create_sample(code="11NECKUP00H3MOYB", mode="sin", y_range=(-15,20), unit="Nm", noise_per=0.01),
        create_sample(code="11NECKUP00H3FOXA", mode="sin", y_range=(-300,400), unit="N", noise_per=0.01),
        create_sample(code="11NECKUP00H3FOZA", mode="pulse", y_range=(0,1200), unit="N", noise_per=0.01),
        ...
        isomme_list=[
            Isomme(
                ...
                channels=[
                    ...
                    create_sample(code="11TIBI0000H3FOZB", y_range=(-2000, 0)).scale_y(scale_y),
